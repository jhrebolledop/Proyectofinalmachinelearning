...
st.write("Definición del algoritmo implementado para predecir si un paciente tiene diabetes o no")

st.subheader("Variables médicas")
features = ['Embarazos (Pregnancies)', 'Glucosa (Glucose)', 'Presión arterial (BloodPressure)', 'Grosor de la piel (SkinThickness)', 'Insulina (Insulin)', 'IMC (BMI)', 'DiabetesPedigreeFunction (DiabetesPedigreeFunction)', 'Edad (Age)']
st.write("A continuación, ingrese los valores de las variables médicas:")        
...
def user_input_parameters():
    ...
    data_features = {
        ...
        'DiabetesPedigreeFunction' : inputs[features[6]],
...
if predict_clicked:
    ...
    prediction_descriptions = {
        0: 'El paciente no tiene diabetes',
        1: 'El paciente tiene diabetes',
    }
